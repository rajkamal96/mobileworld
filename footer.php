        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <h4 class="font-rubik font-size-20">MOBILE WORLD</h4>
                    <p class="font-size-14 font-raleway text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis libero, sunt quos nam suscipit nihil ut, dolorum ab, quas at dicta fugiat possimus ratione itaque? Maxime dolores nostrum accusantium accusamus?</p>
                </div>
    ...
    <div class="copyright text-center bg-dark text-white py-2">
        <p class="font-raleway font-size-14">&copy;<a href="#" class="color-second">MOBILE WORLD</a></p>
    </div>
